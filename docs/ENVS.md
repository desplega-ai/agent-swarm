...
| `LEAD_PORT` | `3020` | Host port mapped to the lead container's port 3000. Used in `docker-compose.example.yml`. |
| `WORKER1_PORT` | `3021` | Host port mapped to worker-1 container's port 3000. Used in `docker-compose.example.yml`. |
| `WORKER2_PORT` | `3022` | Host port mapped to worker-2 container's port 3000. Used in `docker-compose.example.yml`. |
