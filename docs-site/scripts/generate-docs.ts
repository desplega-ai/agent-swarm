...
const indexMdx = `---
title: API Reference
description: Complete REST API reference for Agent Swarm — ${totalOps} endpoints across tasks, agents, workflows, memory, webhooks, and more. Build multi-agent orchestration with HTTP APIs and real-time event streaming.
---
