...
- [**Notion**](/docs/integrations/notion) — read-only KB. OAuth public integration → 4 MCP tools (`notion-search`, `notion-get-page`, `notion-query-database`, `notion-list-databases`). Phase 1 — writes and tracker support are roadmapped.
