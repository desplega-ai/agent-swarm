...
| `parentTaskId` | For follow-up continuity — child tasks inherit bounded prior-task context for every harness, and resumable providers can also reuse the parent's native session |
