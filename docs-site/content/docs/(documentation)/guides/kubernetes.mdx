...
An opt-in origin allowlist is proposed in [PR #1436](https://github.com/desplega-ai/agent-swarm/pull/1436). It is pending, not a shipped configuration option in this guide.
