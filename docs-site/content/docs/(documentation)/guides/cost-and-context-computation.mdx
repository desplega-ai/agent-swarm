...
The `pricing` table is seeded at server boot from the vendored models.dev snapshot at `ui/src/lib/modelsdev-cache.json` plus a small set of manual overrides for items models.dev doesn't carry.
...
Operator reference: [`src/providers/pricing-sources.md`](../../../../../src/providers/pricing-sources.md).
...
- [`src/providers/pricing-sources.md`](../../../../../src/providers/pricing-sources.md) — operator workflow
- [`BUSINESS_USE.md`](../../../../../BUSINESS_USE.md) — flow diagrams for `task` / `agent` / `api` events
