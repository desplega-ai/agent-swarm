...
- [**Litmus Tests**](./patterns/litmus-tests) — a different-model-family judge hard-rejects sub-bar drafts before publish.
- [**HITL Gates**](./patterns/hitl-gates) — every piece of content goes through human craft, tailoring, or feedback before release.
