---
title: Code Health Reports on Autopilot
...
This playbook turns behavioral code analysis into a recurring swarm report. It is separate from [Code Health & Alert Management](/docs/playbooks/code-health-alert-management): that playbook covers alert triage and repair loops; this one is the **reports-on-autopilot** flow for Code Maat + D3.js.
