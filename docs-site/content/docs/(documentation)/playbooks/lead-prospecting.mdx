...
- **`request-human-input`** — the HITL gate. Workflow pauses until a human reacts in Slack. See the [HITL Gates pattern](./patterns/hitl-gates).
...
- [**HITL Gates**](./patterns/hitl-gates) — a human approves before any outbound email sends.
