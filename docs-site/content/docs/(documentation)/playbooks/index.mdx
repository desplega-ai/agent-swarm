---
title: Playbooks
description: Nine production playbooks for running an agent swarm — feature development, prospecting, content, UX audits, customer support, code health, code-health reports, cross-source reports, and self-documenting releases. Real flows, real schedules, real agents.
---
...
- [Code Health Reports on Autopilot](/docs/playbooks/code-health-reports) — Recurring Code Maat + D3.js reports for any Git repository, refreshed weekly by default and published to one stable Page URL.
