...
- **[Proactive customer support](../proactive-customer-support)** — each top account has a directory. A post-call [Granola](https://www.granola.ai/) transcript appends automatically; the next report-generation task reads months of accumulated context.
...
- Pair with the [HITL gate](./hitl-gates): the directory feeds the draft; a human approves the send.
