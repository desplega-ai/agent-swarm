---
title: Code Health & Alert Management
...
- **[Coder](https://templates.agent-swarm.dev/official/coder)** (ours is *Picateclas*) — implements fixes once triaged.
...
- [**Drain Loops**](./patterns/drain-loops) — weekly code-health turns top-N concerns into one PR each.
- [**HITL Gates**](./patterns/hitl-gates) — destructive ops (disk prunes) wait for a human approval.
- [**No-op When Nothing Changed**](./patterns/no-op-workflows) — audits that skip silently on a quiet day.
