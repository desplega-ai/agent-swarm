...
- **`daily-docs-update`** — daily. Checks if any PRs merged in the last 24h. **No-op if none.** Otherwise updates docs + CHANGELOG + timestamps, cuts a release if needed. See the [No-op pattern](/docs/playbooks/patterns/no-op-workflows).
