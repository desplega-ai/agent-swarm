...
- [Release Notes Index](/docs/releases) — View all release notes
- [Discoverability Optimizer](/docs/guides/discoverability-optimizer) — Learn about the SEO optimization template
- [GitHub Integration](/docs/guides/github-integration) — Deep-dive into GitHub webhook handling
- [Contributing](/docs/contributing) — Build and extend Agent Swarm
