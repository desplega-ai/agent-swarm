...
| Variable | Default | Description |
|----------|---------|-------------|
| `SWARM_CLOUD` | `false` | When `true`, marks the deployment as cloud-hosted. Surfaces Docs/Support/Billing items in the user-menu and suppresses the self-host marketing footer |
