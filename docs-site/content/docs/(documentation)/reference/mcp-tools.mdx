...
- **Deferred tools** (72) — Discovered on demand via Claude Code's Tool Search when the agent needs them (scheduling, epics, config, skills, workflows, MCP servers, file operations, etc.)
