---
title: Telemetry
description: What telemetry Agent Swarm collects, how it's anonymized, and how to opt out — lifecycle event tracking for server starts, task creation, worker status, and integration usage without PII collection
---
