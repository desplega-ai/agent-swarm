...
| Security & access | `RBAC_ENABLED`, `BUDGET_ADMISSION_DISABLED`, `MCP_OAUTH_ALLOW_PRIVATE_HOSTS`, `CORS_ALLOWED_ORIGINS` (exact origins or `https://*.agent-swarm.dev`; wildcards exclude apex, unset reflects any origin) |
