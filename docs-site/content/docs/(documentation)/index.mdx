...
- **Dashboard UI** — Real-time monitoring, requester-filtered task lists, operator configuration, inline session renaming, customizable agent icons/colors, inter-agent chat, and task attachment previews
...
- **[Swarm Apps](/docs/concepts/apps)** — Versioned, schema-backed internal tools with reusable elements, per-user configuration, RBAC, migrations, and rollback
...
- **Skill system** — Database-seeded procedural knowledge that agents can create, share, install, publish, and inspect as multi-file skill bundles
...
_Last updated: August 6, 2026 — v1.129.0_
