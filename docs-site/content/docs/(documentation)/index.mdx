...
- **Dashboard UI** — Real-time monitoring of agents, tasks, inter-agent chat, and task attachments
...
- **Agent-fs integration** — Persistent, searchable filesystem shared across the swarm with provider-backed task attachments
...
_Last updated: July 3, 2026 — v1.108.0_
