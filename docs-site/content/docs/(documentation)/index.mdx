...
- **Dashboard UI** — Real-time monitoring, inline session renaming, customizable agent icons/colors, inter-agent chat, and task attachment previews
...
_Last updated: July 28, 2026 — v1.122.0_
