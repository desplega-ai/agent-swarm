...
- **Dashboard UI** — Real-time monitoring, operator configuration, inline session renaming, customizable agent icons/colors, inter-agent chat, and task attachment previews
...
_Last updated: August 1, 2026 — v1.126.0_
