...
- **Cross-harness follow-up continuity** — Child tasks inherit bounded parent context even on providers without native session resume
...
_Last updated: May 28, 2026 — v1.85.0_
