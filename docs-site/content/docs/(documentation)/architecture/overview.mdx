...
- Uses a configurable AI harness — Claude Code (default), Codex, pi-mono, or Devin — selected via `HARNESS_PROVIDER`. See [Harness Configuration](/docs/guides/harness-configuration)
...
| AI Runtime | Claude Code (default), Codex, pi-mono, or Devin — selected via `HARNESS_PROVIDER`. See [Harness Configuration](/docs/guides/harness-configuration) |
