...
- **Swarm Apps** — build schema-backed internal tools with versioned definitions, reusable pure or bound elements, per-user configuration, RBAC, migration-aware schema changes, and rollback history. [Apps API →](https://docs.agent-swarm.dev/docs/api-reference/apps)
