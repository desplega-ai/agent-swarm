...
- **Real-time dashboard + task attachments** — monitor agents, tasks, and inter-agent chat, and create tasks with uploaded files from the sessions composer. [app.agent-swarm.dev →](https://app.agent-swarm.dev)
