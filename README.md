...
AgentMail archives verified inbound deliveries before acknowledgment, including unauthenticated, blocked, and spam events. The minimized archive expires after 30 days; domain filters still control task routing. See the [contact inbox triage runbook](runbooks/contact-inbox-triage.md) for coverage limits and rollout.
