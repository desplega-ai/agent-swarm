...
- **Capability-gated MCP surface** — expose only the tool groups a deployment needs while scripts retain the full allowlisted SDK bridge and worker prompts automatically omit disabled integrations. [MCP tools →](https://docs.agent-swarm.dev/docs/reference/mcp-tools#capability-flags)
