---
name: gws-drive
description: CLI reference for Google Drive operations via gws — list, search, export, create, update, and comment on files in a Shared Drive using a GCP service account.
