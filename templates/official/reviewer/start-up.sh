...
# AgentMail skill (full install with references)
mkdir -p /home/worker/.claude/skills/agentmail-to-agentmail-skills-agentmail/references
if [ ! -f /home/worker/.claude/skills/agentmail-to-agentmail-skills-agentmail/SKILL.md ]; then
  curl -sL -o /home/worker/.claude/skills/agentmail-to-agentmail-skills-agentmail/SKILL.md \
    https://raw.githubusercontent.com/agentmail-to/agentmail-skills/main/agentmail/SKILL.md
  curl -sL -o /home/worker/.claude/skills/agentmail-to-agentmail-skills-agentmail/references/webhooks.md \
    https://raw.githubusercontent.com/agentmail-to/agentmail-skills/main/agentmail/references/webhooks.md
  curl -sL -o /home/worker/.claude/skills/agentmail-to-agentmail-skills-agentmail/references/websockets.md \
    https://raw.githubusercontent.com/agentmail-to/agentmail-skills/main/agentmail/references/websockets.md
fi

# Ensure AgentMail permissions in settings.json
