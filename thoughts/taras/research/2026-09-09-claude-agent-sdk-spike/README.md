...
Set the environment file path for your checkout.
Set the Claude executable path when you test an external executable.
...
UUIDs use consistent aliases, and the installed executable path is redacted.
