...
- [x] Settings → Configuration screenshot session (agent-browser; `/tmp/dreaming-phase4-qa/`):
      ...
      **Review-round outcome (4 reviewers + QA)**: two-stage gather (cheap unprivileged preflight
      ...
      (persisted as `workflow_runs.definitionHash`, migration 129), receipt audit records
...
#### Automated Verification:
- [x] Migration applies on a fresh DB (`130_retire_daily_evolution_monolith.sql` — 126-128 were taken
