...
- `DailyEvolution` → `../agent-swarm.mp4` (the README hero until 2026-09): the "compounding memory" pitch
...
The current README hero, `../agent-swarm-every-team.mp4` ("Every team, one swarm"), is not rendered here. It comes from the `readme` template in the Agent Swarm videos monorepo (desplega-ai/agent-swarm-videos).
