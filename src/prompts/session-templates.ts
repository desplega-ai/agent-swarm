...
The task has three endings. When you are done: \`completed\`. When a person must decide: \`request-human-input\`. When nothing else is possible: \`failed\` with the blocker.
`,
  variables: [],
  category: "system",
});
