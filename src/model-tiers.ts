...
export const DEFAULT_MODEL_TIER_MAP: Record<ProviderName, Record<ModelTier, string>> = {
  ...
  pi: {
    smol: "openrouter/qwen/qwen3-coder-flash",
    regular: "openrouter/google/gemini-3-flash-preview",
  ...
  opencode: {
    smol: "openrouter/qwen/qwen3-coder-flash",
    regular: "openrouter/google/gemini-3-flash-preview",
    smart: "openrouter/anthropic/claude-opus-4.8",
    ultra: "openrouter/anthropic/claude-fable-5",
  },
  devin: {
    smol: "devin",
    regular: "devin",
